...
fun SettingsScreen(openLogin: () -> Unit) {
    ...
    var redirect by remember { mutableStateOf(prefs.get("redirect_uri", "http://127.0.0.1:8000/callback")) }
...
fun LoginDialog(onDismiss: () -> Unit) {
    ...
    var ru by remember { mutableStateOf(prefs.get("redirect_uri", "http://127.0.0.1:8000/callback")) }
